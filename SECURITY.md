...
## Overview
This document belongs to the iOS Web3 Wallet Framework repository. It explains goals, scope, and usage.
...
## Installation (SPM)
```swift
.package(url: "https://github.com/owner/iOS-Web3-Wallet-Framework.git", from: "1.0.0")
```
