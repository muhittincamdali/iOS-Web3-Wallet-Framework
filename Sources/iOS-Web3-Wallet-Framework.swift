...
/// 
/// iOS-Web3-Wallet-Framework provides developers with professional-grade tools and patterns
/// for building exceptional iOS applications.
public final class iOS-Web3-Wallet-Framework {
    ...
    public func configure() {
        ...
        print("✅ iOS-Web3-Wallet-Framework configured successfully")
    }
    
    /// Reset the framework to initial state
    public func reset() {
        isConfigured = false
        print("🔄 iOS-Web3-Wallet-Framework reset to initial state")
    }
...
public enum iOS-Web3-Wallet-FrameworkError: Error, LocalizedError {
